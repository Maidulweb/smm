                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <form class="form-row" action="{{ route('user.ticket.reply', $ticket->id)}}" method="post"
                                ...
                                <div class="col-sm-2 col-12">
                                    <div
                                        ...
                                        <div class="upload-btn upload-btn-new">
                        ...
                        @if(count($ticket->messages) > 0)
                            <div class="chat-box scrollable position-relative scroll-height ps-container ps-theme-default" data-ps-id="18ef099f-e3cf-3269-fbe1-7e23214a4a1c">
