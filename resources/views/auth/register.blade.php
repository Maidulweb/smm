        ...
        <div class="container">
                    <form  method="POST" action="{{ route('register') }}">
                        ...
                        <div class="signin_wraper">
                            <h4 class="text-gradient text-center">Signup</h4>
                            <hr>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="phone">Phone</label>
                                            <input type="text" name="phone" class="form-control" value="{{old('phone')}}" placeholder="@lang('Your Phone Number')">
                            ...
                            <div class="text-center">
                                <p class="mb-0"> @lang('Already have an account?')<a href="{{ route('login') }}">@lang('Login here')</a></p>
                            </div>
                        </div>
